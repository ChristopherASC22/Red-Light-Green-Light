...
function preload() {
  trapSoundTrack = loadSound("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/trapSoundTrack.mp3?v=1658501177939");
  partySoundTrack = loadSound("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/partySoundTrack.mp3?v=1658504526896");
  crazySoundTrack = loadSound("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/crazyCutzSoundTrack.mp3?v=1658504533706");
  classicSoundTrack = loadSound("https://cdn.glitch.me/6171c285-4f64-43e3-95c0-26f0e1eea77b/classicSoundTrack.mp3?v=1658504545107");
  looking = loadImage("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/squidGameLooking.jpg?v=1658508913868");
  turned = loadImage("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/squidGameTurned.webp?v=1658508920253");
  sandBackground = loadImage("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/sandBackground.webp?v=1658508904795");
lM1= new meme(loadImage("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/LossCardSG.webp?v=1658524612626"), 500,408)
lM2= new meme(loadImage("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/LossCardSG2.jpg?v=1658524619585"), 700,700)
lM3= new meme(loadImage("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/LossCardSG3.jpg?v=1658524624383"), 700,712)
lM4= new meme(loadImage("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/LossCardSG4.jpg?v=1658524628905"), 700, 516)
lM5= new meme(loadImage("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/LossCardSG5.jpg?v=1658524631999"), 700, 595)
wM1= new meme(loadImage("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/WinCardSG.jpg?v=1658524637959"), 500,700)
wM2= new meme(loadImage("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/WinCardSG2.jpg?v=1658524641337"),700, 538)
wM3= new meme(loadImage("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/WinCardSG3.jpg?v=1658524644243"), 704, 396)
wM4= new meme(loadImage("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/WinCardSG4.jpg?v=1658524646819"), 700, 405)
wM5= new meme(loadImage("https://cdn.glitch.global/6171c285-4f64-43e3-95c0-26f0e1eea77b/WinCardSG5.jpg?v=1658524649213"), 700, 694)
...
function draw() {
  if (currentState == "none") {
    ...
    image(winnerMemes[index].img, 150,150,winnerMemes[index].length,winnerMemes[index].width )
    }
